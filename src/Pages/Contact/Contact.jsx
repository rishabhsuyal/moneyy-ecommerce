...
function Contact() {
    return (
        <>
            <img alt="img" className='chain-image' src={Chain} />
                ...
                <div className='icon-container'>
                   <p className='stay' >Stay in touch</p>
                    <div className='image-container'>
                        <img alt="img" className='icon-image' src={twitter} />
                        <img alt="img" className='icon-image' src={facebook} />
                        <img alt="img" className='icon-image' src={insta} />
                    </div>
                </div>
            </div>
        </>
